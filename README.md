...
The separate **Voice Integrations** app provides a **Pause voice output**
control for this plugin's Stop and permission notifications, plus `/say`
and `/summary-say`. Open the controller from Applications or Spotlight.
